...
public class NoteController {
	...
	public String getAllNotes(ModelMap map) {
		List list = (List) noteRepository.getAllNotes();
	...
	public String addNote(@Validated @ModelAttribute("note") Note note, ModelMap map) {
	...
	public String deleteNote(@RequestParam("noteId") int noteId) {
		boolean del = noteRepository.deleteNote(noteId);
		return "redirect:/";
	}
